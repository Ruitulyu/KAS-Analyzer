...
## -----------------------------------------------------------------------------
# perform case-only time course(TC) KAS-seq differential analysis using ImpulseDE2 package without batch effect normalization.
...
write.csv(objectImpulseDE2$dfImpulseDE2Results, "KAS-seq_case_only_TC_ImpulseDE2_output.csv")

## -----------------------------------------------------------------------------
# Visualization of global TC KAS-seq patterns via a heatmap

# Visualize global TC KAS-seq patterns and save it as png plot.
png(file="KAS-seq_case_only_TC_ImpulseDE2_heatmap.png", bg="transparent")
plotHeatmap(
...
png(file="KAS-seq_case_only_TC_ImpulseDE2_heatmap.svg", bg="transparent")
plotHeatmap(
  objectImpulseDE2       = objectImpulseDE2,
  strCondition           = "case",
  boolIdentifyTransients = TRUE,
