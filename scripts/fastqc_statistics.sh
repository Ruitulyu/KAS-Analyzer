#!/bin/bash
# 'KAS-pipe2 statistics' was developed by Ruitu Lyu on 12-21-2021.

# Stop on error
set -e

# help arguments
usageHelp="Usage: KAS-pipe2 statistics [ -h/--help ] [ -o prefix ] [ -l labels ] [ -s summary folder ]"
exampleHelp="Example: nohup KAS-pipe2 statistics -o KAS-seq_statistics -l labels.txt -s summary.txt &"
prefixHelp="-o [prefix]: please input the prefix (basename) of 'KAS-pipe2 statistics' output files. REQUIRED."
labelsHelp="-l [labels]: please input the txt file containing labels of (sp)KAS-seq summary file generated by 'KAS-pipe2 (sp)KAS-seq'. Default: basename of summary file.
KAS-seq.rep1
KAS-seq.rep2
KAS-seq.rep3
...
# if no parameters was provided, 'KAS-pipe2 statistics' will print the help.
...
if test -z $prefix ;then
   echo ""
   echo "Please specify the prefix (basename) of 'KAS-pipe2 statistics' output files. -o [prefix]"
   echo ""
   exit -1
fi
...
echo "'KAS-pipe2 statistics' run successfully!"
