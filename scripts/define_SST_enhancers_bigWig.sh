...
exampleHelp="Example: nohup KAS-pipe2 SST_enhancer -o KAS-seq_SST_enhancers -t 10 -s mm10 -e H3K27ac_enhancers.bed -p KAS-seq_peaks.bed -k KAS-seq.rep1.bigWig,KAS-seq.rep2.bigWig &"
